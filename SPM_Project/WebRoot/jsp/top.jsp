...
<body margin="0" id="top">
	<div id="menu2" class="menu" style="margin-left:30%;z-index: 99999">
		<ul>
			<li><a href="${pageContext.request.contextPath}/enterIndex.do"
				target="right">首页</a></li>
			<li><a
				href="${pageContext.request.contextPath}/findTradeInfoList.do"
				target="right">行业信息</a></li>

			<c:if test="${not empty session.user  }">
				<li><a
					href="${pageContext.request.contextPath}/listDownLoad.do"
					target="right">下载区</a></li>
				<li>
			</c:if>
			<!-- <s:if test="#session.user.position=='学生'">
					...
					-->
			<a
				href="${pageContext.request.contextPath}/jsp/course/courseSelect.jsp"
				target="right">选课</a>
			<!--<s:else>	
			...
			<li>
				<!-- 	<a href="../score/2012score.html" target="right">成绩查询</a>
					<a href="GetScoreAction.action"  target="right">成绩查询</a> --> <a
				href="${pageContext.request.contextPath}/jsp/course/scoreQueryList.jsp"
				target="right">成绩查询</a>
			...
			<c:if test="${not empty session.user  }">
				<li><a
					href="${pageContext.request.contextPath}/jsp/message/mainMessage.jsp"
					target="right">留言板</a></li>
			</c:if>
			<li><a href="${pageContext.request.contextPath}/listExam.do"
				target="right">网上测试</a></li>
			<li><a
				href="${pageContext.request.contextPath}/enterintro.do?name=lianxiwomen"
				target="right">联系我们</a></li>
			...
			<c:if test="${session.user.position=='1'}">
				<li>
					...
					<a
					href="${pageContext.request.contextPath}/jsp/manage/manageUser.jsp"
					target="right">人员管理</a>
				</li>
				<li><a
					href="${pageContext.request.contextPath}/jsp/manage/configInfo.jsp"
					target="right">系统配置</a></li>
