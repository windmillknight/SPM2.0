...
<html>
  ...
  function uploadPeople(){
	 	...
	 	$('#dlg1').dialog('open').dialog('setTitle','成绩上传');
 ...
 <table style="background:#efefef; border-collapse:collapse ;"   width="100%" height="80" cellspacing="5" cellpadding="5"> 
 	<tr>
    	...
    	<td width="25%">
 	    ...
 	    <div style="text-align:center;padding:5px">
			...
			<input type="button" class="btn btn-default" style="margin-right:20px;" onclick="uploadPeople()" value="批量添加" /> 
  ...
  <div>
    ...
    <div id="dlg1" class="easyui-dialog"  style="padding:10px 20px;width: 700px" closed="true" buttons="#dlg-buttons" >   
