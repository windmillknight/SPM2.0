		...
		<div class="leftsidebar_box">
			<dl class="channel" style="margin-top: 20px">
				...
				<dt onClick="changeImage()">
					课程介绍 <img src="../images/left/select_xl01.png">
				</dt>
				<dd class="first_dd">
			...
			<dl class="system_log">
				...
				<dt onClick="changeImage()">
					课程内容 <img src="../images/left/select_xl01.png">
				</dt>
				<dd class="first_dd">
				...
				<c:if test="${session.user.position!='3'}">
					<dd>
						<a href="${ctx}/checkStudentCourse.do" target="right">&nbsp;&nbsp;&nbsp;&nbsp;查看学习进度</a>
					</dd>
				</c:if>
				<dd>
					<a href="${ctx}/jsp/exercise/mainView.jsp" target="right">&nbsp;&nbsp;&nbsp;&nbsp;练习题</a>
				</dd>
				<dd>
			...
			<dl class="custom">
				<div
					style="width: 240px; border-bottom: 1px solid #b6d9e8; margin-left: 100px"></div>
				<dt onClick="changeImage()">
					实验与实践 <img src="../images/left/select_xl01.png">
				</dt>
				<dd class="first_dd">
			...
			<dl class="system_log">
				<div
					style="width: 240px; border-bottom: 1px solid #b6d9e8; margin-left: 100px"></div>
				<dt onClick="changeImage()">
					教学团队 <img src="../images/left/select_xl01.png">
				</dt>
				<dd class="first_dd">
