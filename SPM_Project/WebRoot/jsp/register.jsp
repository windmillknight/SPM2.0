...
// 			alert("开始调用dwr进行登录校验");
		...
		function registerPassWordCharCheck(){
			var passwordMsg = document.getElementById("PasswordMsgCheck");
			var reg = /^[0-9a-zA-Z]+$/
		...
		function registerPassWordCheck(){
			...
			var msg = document.getElementById("PwdCheck");
			var reg = /^(?![^a-zA-Z]+$)(?!\D+$).{6,16}/
			if(reg.test(password)){
				passwordMsg.style.display = "none";	
			}
			else if(length < 6 || length > 16){
				msg.innerHTML = "密码必须为6位以上，16位以下！"
				passwordMsg.style.display = "block";
			}else{
				//alert("dddd");
				msg.innerHTML = "密码必须同时包括字母和数字！"
				passwordMsg.style.display = "block";
			}
		}
									...
									<tr>
										...
										<td>
											<div style="padding-left: 20px; margin-top: 20px;">
												<input type="button" onclick="window.location='${ctx}/jsp/mainFrame.jsp'" value="游客登陆"
					...
					<div class="web_login">
						...
						<ul class="reg_form" id="reg-ul">
							...
							<li>
								...
								<div class="inputOuter2">
									<input type="password" id="passwd" name="user.password" onBlur="registerPassWordCheck();" 
										maxlength="16" class="inputstyle2" onkeyup="registerPassWordCharCheck()"/>
								</div>
								<br>
								<br>
							</li>
							...
							<div class="PasswordMsg" id="PasswordMsg" style="display:none;color:#F00">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<label class="text" for="pm" id = "PwdCheck">
									密码必须为6位以上，16位以下！
								</label>
							</div>
							<div class="PasswordMsg" id="PasswordMsgCheck" style="display:none;color:#F00">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<li>
								...
								<div class="inputOuter2">
								<input type="text" id="email" name="user.email" onBlur="emailtest();"
										maxlength="45" class="inputstyle2" />
								</div>
